...
import { ArrowLeft, Calendar, ShoppingCart, TrendingUp, CheckCircle } from "lucide-react"

export default function BespokeCashmereProject() {
  return (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold text-brand-deep-blue mb-6">Bespoke Cashmere</h1>
                  <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                    Luxury e-commerce platform with custom product configurator and premium user experience that
                    transformed online cashmere shopping.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    {["Next.js", "Shopify", "Stripe", "Tailwind"].map((tech) => (
                      <span
                        key={tech}
                ...
                <div className="relative">
                  <img
                    src="/luxury-cashmere-ecommerce.png"
                    alt="Bespoke Cashmere Platform"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid md:grid-cols-3 gap-8 text-center text-white">
                <div>
                  ...
                  <p className="text-gray-200">Increase in online sales</p>
                </div>
                <div>
                  <ShoppingCart className="h-12 w-12 mx-auto mb-4 text-brand-bright-blue" />
                  <h3 className="text-3xl font-bold mb-2">85%</h3>
                  <p className="text-gray-200">Cart conversion rate</p>
                </div>
                <div>
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    The luxury cashmere brand needed a sophisticated e-commerce platform that could showcase their
                    premium products while providing customers with a personalized shopping experience and custom
                    product configuration options.
                  </p>
                  <h2 className="text-3xl font-bold text-brand-deep-blue mb-6">Our Solution</h2>
                  <p className="text-gray-600 leading-relaxed">
                    We created a premium e-commerce platform with advanced product customization, seamless payment
                    integration, and a luxurious user interface that reflects the brand's high-end positioning.
                  </p>
                </div>
                <div>
                    ...
                    <CardContent className="p-8">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-600">Custom product configurator</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <CheckCircle className="h-5 w-5 text-green-500 mt-1" />
                          <span className="text-gray-600">Premium UI/UX design</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <CheckCircle className="h-5 w-5 text-green-500 mt-1" />
