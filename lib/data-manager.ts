...
const defaultData: WebsiteData = {
  hero: {
    ...
    primaryButtonLink: "https://calendly.com/macgw86/30min", // Updated primary button Calendly link to new URL
  ...
  specialOffer: {
    ...
    buttonLink: "https://calendly.com/macgw86/30min", // Updated special offer Calendly link to new URL
    active: true,
  },
  contact: {
